...
STARTUP = ./lib/startup/startup_ARMCM4.s
 
# List all include directories here
INCDIRS = ./include ./CMSIS/Core/Include ./CMSIS/Device/ST/STM32F4xx/Include
...
LINKER_SCRIPT = ./ldscripts/stm32f407xx_gcc.ld
...
CPFLAGS = $(MCFLAGS) $(OPT) -g -gdwarf-2 -mthumb -ffunction-sections -fomit-frame-pointer -Wall -Wstrict-prototypes -fverbose-asm -Wa,-ahlms=$(<:.c=.lst) $(DEFS)
